...
The short list will be made up from the most promising items identified in the long list. The full list will be carefully evaluated based on the following criteria:
\begin{itemize}
	\item Complexity: will this change be feasable within the time-span of this research?
	\item Meeting requirements: based on the requirements identified at the start, is there value in updating this piece of the infrastructure?
	\item Importance: is spending time on updating this part of the infrastructure able to deliver a significant increase in performance?
\end{itemize}
This short list will then be presented to the automation team for feedback.
