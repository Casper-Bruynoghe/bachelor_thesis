...
A proof-of-concept (PoC) will be made with the selected changes from the short list. Each of these will be tested according to the previously defined requirements. 
This will then be presented to the automation team to gather feedback. This PoC wil come with data showing improvements over previous version and compared to the current system.\\

The PoC will go through several iterations before coming to a suitable solution that can be implemented.
