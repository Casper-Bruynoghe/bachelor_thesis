...
Er zal grondig onderzoek worden gedaan naar de staat van de huidige infrastructuur. Dit zal een goed overzicht geven van de zwakke punten en mogelijke verbeterpunten.
Het is van groot belang dat het bekend is \textcolor{red}{hoe de verschillende systemen met elkaar communiceren, of de kennis over elk stuk software nog binnen het bedrijf 
aanwezig is en wanneer iemand er voor het laatst mee heeft gewerkt.}

\subsection{Verzamelen van vereisten}
\textcolor{green}{Stel de subvraag over welke metrics er nodig zijn om de performantie te evaluaren}
...
successcriteria: meets requirements and is maintainable for a long time.
