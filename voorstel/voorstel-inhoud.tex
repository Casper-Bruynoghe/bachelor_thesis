...
\begin{itemize}
  \item Cold start: dit gebeurt wanneer het systeem voor het eerst wordt opgestart. Tijdens dit proces worden de message queues, dynamische logboeken en herstart datasets geïnitialiseerd
