...
This research will have a significant impact within KBC due to the fact that IBM mainframes require a subscription based on the amount of CPU time is used over a period of time. Therefore, if a heavily used piece of software, such as IMS,
gets optimized and reduced in CPU time, the company will be able to save money and the maintainance of the system will be easier to handle by the various infrastructure teams.\\

It is expected that there will be a significant improvement will be made on the time it takes for an IMS (sub)system to start or stop. This also includes a removal of dead code and generally improving upon older processes.
