...
\subsection{Collecting requirements}
Before starting, a clear understanding of the requirements for a viable solution has to be ensured. To achieve this, the research will segment the problem and collect all the requirements.\\

First there will be an in depth meeting held with the appropriate staff at KBC, where the requirements will be discussed and possible ordered from most important to least important.\\

Secondly, based on the results of the first step, there will be a stage of defining key performance metrics. For example:
\begin{itemize}
	\item Percentage of dead code removed.
	\item Decrease of average startup/shutdown time.
\end{itemize}

Finally there will be a comprehensive list made of all the requirements the solution must abide by to be considered suitable. This list will be organized according to 
the \href{https://en.wikipedia.org/wiki/MoSCoW_method}{MoSCoW} method.
