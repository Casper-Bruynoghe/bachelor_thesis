...
This phase's goal is to create a long list of identified problems, inneficiencies and bottlenecks. This will give a clear overview of where the biggest improvements can be made in the current architecture.
